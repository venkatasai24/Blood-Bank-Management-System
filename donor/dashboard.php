    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#FF0000;"> -->
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="?donate_blood=1" style="color:#333333; margin: 0 10px;">Donate Blood</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?donations_history=1" style="color:#333333; margin: 0 10px;">Donation History</a>
                </li> -->
            </ul>
            <div class="ml-auto">
                <ul class="navbar-nav">
